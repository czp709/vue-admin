<template>
  <div class="fullscreen">
    <el-tooltip class="item" effect="dark" :content="`点击${fullscreen ? '关闭' : '打开'}全屏显示`" placement="bottom">
      <svg v-if="!fullscreen" @click="handleFullScreen" t="1652066238767" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1912" width="20" height="20">
        <path
      ...
      <svg v-else @click="handleFullScreen" t="1652066251196" class="icon" viewBox="0 0 1024 1024" version="1.1"
